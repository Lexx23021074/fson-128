...
git pull — обов'язково роби це, якщо власник репозиторію (YK911) міг оновити
матеріали, або якщо ти сам щось змінював з іншого комп'ютера.

Працюєш (додаєш файли, робиш нотатки).

Зберігаєш своє: git add . -> git commit -m "my notes" -> git push.

Маленький нюанс (Важливо!) Ти зможеш робити git push у цей репозиторій тільки
якщо:

Це твій власний репозиторій (ти його створив або зробив Fork).

Або якщо власник (YK911) додав тебе як співавтора (Collaborator).

Якщо це чужий навчальний репо, то git push видасть помилку (Access Denied). У
такому разі ти зможеш тільки робити git pull (забирати оновлення), а свої зміни
зберігати лише локально

2:16:00 -2:22:00 - опсано як робити кнопочку зі зіміною ціни і напису

codepen.io/pen/ - тут можна гратись з кодом https://codepen.io/pen/
